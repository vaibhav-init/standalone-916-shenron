...
def convert_sem_lidar_2D_img_func(sim_radar, invert_angle, limit = 75):
    ...
    # Get the directory where THIS script (convert2D_img.py) is located
    current_script_dir = os.path.dirname(os.path.abspath(__file__))
    # The config is in ../e2e_agent_sem_lidar2shenron_package/simulator_configs.yaml relative to this script
    config_path = os.path.join(current_script_dir, '../e2e_agent_sem_lidar2shenron_package/simulator_configs.yaml')
